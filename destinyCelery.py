...
def ansible_playbook_manual_view(request, user_id, project_id, playbook_id):
    ansible_playbook_manual.delay(user_id, project_id, playbook_id)
    return HttpResponse("ansible_playbook_manual task sent")
